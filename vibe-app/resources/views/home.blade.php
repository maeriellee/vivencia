...
<img alt="Warm artisan Filipino panaderia counter with ube creme brulee and dulce de leche chocolate cake in San Antonio" class="w-full h-full object-cover object-[center_35%] filter brightness-95 contrast-105" src="/images/vivencia/header-photo.jpg">
...
<div class="relative z-10 max-w-[1280px] mx-auto px-margin md:px-margin-tablet lg:px-margin-desktop pt-16 pb-20 lg:pt-24 lg:pb-28 min-h-[620px] flex flex-col justify-end">
<!-- Live Badge Pill -->
